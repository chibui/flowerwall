...
// mongoose.connect(process.env.MONGODB_URI) || mongoose.connect(process.env.FLOWERWALL);
...
// view engine setup
app.engine('.hbs', expressHbs({defaultLayout:'layout', extname: '.hbs'})); // set handlebars as layout engine
